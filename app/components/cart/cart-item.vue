<template>
  <tr>
    ...
    <td class="tp-cart-img">
      <nuxt-link :href="`/producto/${item.slug || item.id}`" style="background-color: #F2F3F5;display: block;">
    ...
    <td class="tp-cart-action">
      <button class="tp-cart-action-btn" @click="cartStore.removeCartProduct(item)">
        <svg-remove />
        <span>Remove</span>
      </button>
    </td>
